...
export class Product {
    ...
    constructor(props: ProductProps) {
        ...
        if (props.description.length < 10) throw "Description must have at least 10 characters";
    ...
    update(props: ProductUpdate) {
        if (props.name && props.name.length < 8) throw "Name must have at least 8 characters";
        if (props.description && props.description.length < 10) throw "Description must have at least 10 characters";
